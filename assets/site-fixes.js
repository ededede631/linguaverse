(function () {
  ...
  function openInfo(type) {
    ...
    const content = {
      roadmap: "<p><b>已实现能力（静态站点可落地）：</b></p><ul><li>本地学习记录、生词本、错题复盘、打卡日历</li><li>章节闭环学习：视频 + 知识点 + 重点词汇 + 练习</li><li>日语 / 韩语拼写触屏手写练习</li><li>单词记忆、语法练习、口语跟读、听力训练、拼写练习 5 大模块</li><li>英语 / 日语 / 韩语 × 初级 / 中级 / 高级，共 9 套内容</li><li>移动端适配、离线缓存、隐私与版权说明</li></ul><p><b>仍需后端才能真正解决（能力边界）：</b></p><ul><li>账号登录与云端多端同步</li><li>专业客服与工单系统</li><li>AI 发音实时评分</li><li>正版海量内容库与教研团队</li><li>ICP 备案、教育资质、等保与内容风控</li></ul>",
